...
class AddLeaveRedirectScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _AddLeaveRedirectScreen();
}

class _AddLeaveRedirectScreen extends State<AddLeaveRedirectScreen> {
            ...
            body: isloading
              ...
              body: Form(
                child: Stack(
                  children: <Widget>[
                    Container(
                      padding: new EdgeInsets.fromLTRB(30.0, 20.0, 20.0, 20.0),
                              ...
                              child: IgnorePointer(
                                ...
                                child: new TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: ('${formatter.format(start_currentdate)}'),
                                                    ...
                                                    Container(
                                                        ...
                                                        child: DropdownButton(
                                                          ...
                                                          onChanged: (value) {
                                                            ...
                                                            selected_list[index] = ddl.indexOf(value);
                                                            setState(() {});
                                                          })
                              ...
                              children: <Widget>[
                                FlatButton(
                                  onPressed: () async {
                                    ...
                                    List<int> newselected_list = List<int>();
                                    for (int i = 0;
                                    ...
                                    String dayof_leave_array = newselected_list.join(',');
  ...
  Future<void> _selectToDate(BuildContext context) async {
    ...
    DatePicker.showDatePicker(context,
        ...
        onConfirm: (date1) {
          ...
          var difference = end_currentdate
              .difference(start_currentdate)
              .inDays + 1;
