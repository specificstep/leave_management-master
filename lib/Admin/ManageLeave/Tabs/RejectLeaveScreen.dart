...
class RejectLeaveScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _RejectLeaveScreen();
}

class _RejectLeaveScreen extends State<RejectLeaveScreen> {
  String token = "";
  String user_id = "";
  List<ManageLeaveList> _list;
  List<ManageLeaveList> RejectedList = [];
  bool isloading = true;
  bool showlist = false;
              ...
              Expanded(child:  Visibility(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      String  str_reason= "Leave Reason : " + RejectedList[index].leave_reason.toString();
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // AutoSizeText(
                                      //   "Leave Reason : "+ RejectedList[index].leave_reason.toString(),
                                      ...
                                      Center(
                                        child: Row(
                                            ...
                                            children: <Widget>[
                                              Expanded(
                                                child:  TextView(
                                                  "Leave Remark : " + RejectedList[index].remark.toString(),
                                                  fontFamily: 'Poppins-Regular',
                                                  fontSize: 16,
                                                  textAlign: TextAlign.start,
                                                  textColor: Colors.black,
        ...
        if (value.data.Result.status == "0") {
          ...
          if (_list.length > 0) {
            for (int i = 0; i < _list.length; i++) {
              if (_list[i].leave_status == "Cancel") {
                RejectedList.add(_list[i]);
              }
            }
            if (RejectedList.length > 0) {
              showlist = true;
            ...
            print("RejectedList  :" + RejectedList.toString());
          }
        }
      }
      setState(() {
